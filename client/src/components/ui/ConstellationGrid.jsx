...
export default function ConstellationGrid() {
    ...
    useEffect(() => {
        ...
        const render = (now) => {
            ...
            // Color paletting for dark/light seamlessness - updated for Somnium (purples)
            const bgColor = isDarkMode ? '#05030f' : '#f8fafc'; // Deep void color for bg
            const nodeColor = isDarkMode ? '255, 255, 255' : '15, 23, 42';
            const accentColor = isDarkMode ? '168, 85, 247' : '147, 51, 234'; // Purple (Amethyst) accent
