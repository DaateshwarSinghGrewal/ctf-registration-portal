...
const setHiDPICanvas = (canvas, ctx) => {
...
const Noise = ({ refresh = 2, alpha = 18 }) => {
...
const SquaresInteractive = ({
  squareSize,
  hoverFillColor = "rgba(168,85,247,0.12)",
  hoverStrokeColor = "rgba(217,70,239,0.50)",
  hoverGlowColor = "rgba(168,85,247,0.30)",
  gridOffsetRef,
  className = "",
}) => {
  const canvasRef = useRef(null);
...
export default function NoiseDarkPurpleGradientWithSquares({
  showGrid = true,
  direction = "diagonal",
  speed = 0.6,
  squareSize = 44,
