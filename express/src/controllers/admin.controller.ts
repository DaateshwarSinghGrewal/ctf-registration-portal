...
// user_auth.userid is a UUID, so route params are validated as non-empty
// strings rather than parsed as integers.
function readUserIdParam(req: Request): string | null {
